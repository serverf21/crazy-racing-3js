...
const MainMenu = () => {
  ...
  return (
		<div className="main-screen">
			<img className="main-cover" ref={backgroundRef} srcSet="static/cover-min.jpg 768w, static/cover.jpg 1024w" sizes="(max-width: 1024px) 100vw, 1024px" src="static/cover.jpg" alt='Circuit Rush Main Screen Cover' style={{ width: 'auto', height: 'auto' }}/>
			<div className="menu">
